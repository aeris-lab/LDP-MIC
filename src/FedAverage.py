...
def parse_arguments():
    ...
    parser.add_argument('--model', type=str, default='mnist_fully_connected_IN', 
                        choices = ['mnist_fully_connected_IN', 'resnet18_IN', 'alexnet_IN', 'purchase_fully_connected_IN', 
                                  'mnist_fully_connected_MIC', 'resnet18_MIC', 'alexnet_MIC', 'purchase_fully_connected_MIC',
                                  'mnist_fully_connected', 'resnet18', 'alexnet', 'purchase_fully_connected'])
